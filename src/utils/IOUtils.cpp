 ...
 */
    vector<string>
    IOUtils::GetFilesInDirectory(const string &directory, const string &searchPattern, bool returnFullPath) {
    ...
    vector<string>
    IOUtils::GetDirectoriesInDirectory(const string &directory, const string &searchPattern, bool returnFullPath) {
        string fullSearch = CombinePath(directory, searchPattern);
